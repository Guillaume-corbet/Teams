...
/*!
\param user_id a character pointer corresponding to the universally unique id
assigned to the currently logged out user
\param user_name a character pointer corresponding to the user name.
...
/*!
\param user_id a character pointer corresponding to the universally unique id
assigned to the user who sended the message.
...
/*!
\param team_id a character pointer corresponding to the universally unique id
assigned to the team hosting the thread.
\param thread_id a character pointer corresponding to the universally unique id
assigned to the thread hosting the reply.
\param user_id a character pointer corresponding to the universally unique id
assigned to the user who sended the message.
...
/*!
\param channel_id a character pointer corresponding to the universally unique
id assigned to the channel in the team.
\param channel_name a character pointer corresponding to the channel's name.
\param channel_description a character pointer corresponding to the channel's
description.
\return On success, 1 is returned. On error, -1 is returned and errno is set
appropriately
*/
...
\param thread_timestamp an unsigned integer corresponding to the timestamp of
...
\param user_status an integer corresponding to the user status (0 = not connec
ted; 1 = connected).
\return On success, 1 is returned. On error, -1 is returned and errno is set
appropriately 
*/
...
/*!
\param thread_id a character pointer corresponding to the universally unique id
assigned to the thread in the team.
\param user_id a character pointer corresponding to the universally unique id
assigned to the user who created the thread.
\param thread_timestamp an unsigned integer corresponding to the timestamp of
the thread's creation.
...
/*!
\param thread_id a character pointer corresponding to the universally unique
id assigned to the thread in the channel.
\param user_id a character pointer corresponding to the universally unique id
assigned to the user who created the thread.
\param reply_timestamp an unsigned integer corresponding to the timestamp of
the reply.
...
id assigned to the user sending the message
...
//! Handler called when the user ask for a user in particular (/user or
//info CLI command)
/*!
\param user_id a character pointer corresponding to the universally
...
//! Handler called when the user ask for a team in particular (/infoCLIcommand)
/*!
\param team_id a character pointer corresponding to the universally unique id
assigned to the team.
\param team_name a character pointer corresponding to the team's name.
...
//command)
/*!
\param channel_id a character pointer corresponding to the universally uniqueid
...
/*!
\param puts(buffer);ead's creation.
\param thread_title a character pointer corresponding to the thread title.
\param thread_body a character pointer corresponding to the thread body.
\return On success, 1 is returned. On error, -1 is returned and errno is set
appropriately
...
/*!
\param thread_id a character pointer corresponding to the universally unique id
assigned to the thread in the channel.
\param user_id a character pointer corresponding to the universally unique id
assigned to the user who created the thread.
\param reply_timestamp an unsigned integer corresponding to the timestamp of
the reply.
