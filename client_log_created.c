...
void log_print_channel_created(char *buffer)
{
    ...
    client_print_channel_created(channel_id, channel_name,
    channel_description);
    free(channel_id);
    free(channel_name);
...
void log_print_reply_created(char *buffer)
{
    ...
    client_print_reply_created(thread, user, timestamp, body);
    free(thread);
    free(user);
    free(str_timestamp);
    free(body);
...
void log_print_team_created(char *buffer)
{
    ...
    client_print_team_created(id, name, description);
    free(id);
    free(name);
    free(description);
}
...
void log_print_thread_created(char *buffer)
{
    ...
    client_print_thread_created(thread, user, timenum, title, body);
    free(timestr);
    free(thread);
    free(user);
    free(body);
